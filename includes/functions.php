...
function displayform($user,$presclass,$submit="submit") {
    ...
    <form method='post' action='' enctype='multipart/form-data' class='form' id='submit_form'>
        ...
        <label for='title' class='pub_label'>Title </label><input type='text' id='title' name='title' value='$presclass->title' size='90%'/><br>
        <label for='summary' class='pub_label'>Abstract </label><br><textarea name='summary' id='summary'>$presclass->summary</textarea><br>
        <label for='authors' class='pub_label'>Authors </label><input type='text' id='authors' name='authors' value='$presclass->authors' size='80%'/></br>
